        ...
        <div class="recipe__ingredients">
          ...
          ${this.data.ingredients.map((item)=>{
            return `<li class="recipe__ingredient">
                        ...
                        <div class="recipe__quantity">${item.quantity ? item.quantity : ""}</div>
